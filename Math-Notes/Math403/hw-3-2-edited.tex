...
\noindent
\textsc{Reading assignments}\total{33}{42}%covers Lectures 13 - 16
...
knowing what a topological space is, since affine spaces have the \red{You need to take the charts into account.}
usual
% topology
...
of a polynomial with coefficients in~$F$ is closed. \red{Your strategy is quite unclear.}
...
corresponding to the 1 in the first vector are 0. \red{This scaling doesn't work for take $\RR$ as a $\QQ$ v.s.: you cannot scale an irrational by a rational to get a rational.}
...
all square roots of~$A$; note that they are all self-adjoint. \red{You should have 4 square roots because you can take $\pm 5,\pm1$.}
...
the image under $A$ of the closed unit disk in~$\RR^2$. \red{Missing detail and no geometric description.}
